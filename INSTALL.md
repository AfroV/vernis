...
4. Click the **gear icon** (settings) and configure:
   ...
   - Set username and password (e.g., `afroX` / `<device-password>`)
...
4. Find Pi's IP address:
   ...
   - Or use: `ping afroX.local`
   - Or scan: `nmap -sn 10.0.0.0/24`
...
|------|-----|----------|----------|-------------|
| afroX | 10.0.0.XX | afroX | <device-password> | Password |
```
